...
|-------|-------|
| `0-meta` | alexandra877 |
| `1-company` | alexandra877 |
| `2-departments` | alexandra877 |
...
| Team | Owner |
|------|-------|
| Workspace Technology (dept) | Sergiu-Valentin Dilimot |
| Employee Subscription Management | Alexandra Ciupe |
| Engineering Tools | Adrian Mihai |
| Collaboration Tools | Andreia Stefania Tutuianu |
| Unified Access & Endpoint | Angela Lascu |
| Process & Governance | Ayse Ozcelik |
| Onboarding & Offboarding | Iulian George Iftode |
| First-Line Support | Cristina Costeiu |
| LATAM (ITC) | Gabriel Del Torto |
